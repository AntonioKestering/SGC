...
async function GET(request, { params }) {
    try {
        ...
        const { data: patient, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('patients').select('*').eq('id', id).single();
        if (error) {
...
async function PUT(request, { params }) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('patients').update(body).eq('id', id).select();
        if (error) {
...
async function DELETE(request, { params }) {
    try {
        const { id } = await params;
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('patients').delete().eq('id', id);
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__88993379._.js.map