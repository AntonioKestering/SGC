...
async function GET() {
    try {
        ...
        const { data: patients, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('patients').select('*').order('created_at', {
            ascending: false
        });
        if (error) {
...
async function POST(request) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('patients').insert([
            {
                full_name,
                cpf: cpf || null,
                phone: phone || null,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3c693493._.js.map