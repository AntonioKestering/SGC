...
async function GET(request, { params }) {
    try {
        ...
        const { data: appointment, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('appointments').select(`
        *,
...
async function PUT(request, { params }) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('appointments').update(body).eq('id', id).select(`
        *,
...
async function DELETE(request, { params }) {
    try {
        const { id } = await params;
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('appointments').delete().eq('id', id);
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__51d64c49._.js.map